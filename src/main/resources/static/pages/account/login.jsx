                                    ...
                                    <form onSubmit={handleSubmit}><div className='mb-3'>
                                        ...
                                        <div className='mb-3'>
                                            <div className='mb-2 w-100'>
                                                ...
                                                <Link href='findPassword'>
                                                    <a className={`${styles.anchor} float-end`}>비밀번호 찾기</a>
                                                </Link>
                                            </div>
                                        ...
                                        <div className='d-flex align-items-center'>
                                            <div className='form-check'>
                                                <input className='form-check-input' id='remain' type='checkbox' name='remain' />
                                                <label className='form-check-label' htmlFor='remain'>로그인 유지</label>
                                            </div>
                                            <button className='btn btn-primary ms-auto' type='submit'>로그인</button>
                                        </div>

                                        <hr className="my-4"></hr>

                                        <div className='text-center my-4'>간편하게 로그인하세요!</div>

                                        <div className='row row-cols-4 justify-content-md-center'>
                                            <div >
                                                <Link className='col' href='/oauth2/authorization/google'>
                                                    <a>
                                                        <Image
                                                            style={{
                                                                borderRadius: '50%',
